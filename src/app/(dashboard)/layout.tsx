        ...
        <NotificationDrawerProvider>
          <main className="flex-1 min-w-0 bg-sidebar">
            ...
            <button
              ...
              aria-expanded="false"
              className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-primary border border-border bg-card text-foreground hover:text-primary transition-colors"
            >
              <svg
